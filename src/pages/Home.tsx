...
const Home = () => {
  const socials = [
    ...
    {
      name: "email",
      href: "mailto:contact@shakirfarhan.com",
      icon: Mail,
    },
  ];
    ...
    <div className="h-screen bg-background text-foreground overflow-hidden relative">
      <section className="h-full flex flex-col items-center justify-center gap-8 px-4 md:px-16">
        <div className="md:text-center">
          ...
          <p className="md:text-lg text-muted-foreground leading-relaxed mb-8 md:mb-12 max-w-4xl mx-auto">
          ...
          >
            <Link
              to="/projects"
              className="px-4 cursor-pointer py-3  text-sm text-background bg-primary tracking-wide transition-all duration-300 hover:bg-primary/80 rounded-md font-semibold hover:-translate-y-1"
            >
              Explore My Work
            </Link>
            <Link
